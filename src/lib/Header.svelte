...
<div class="flex w-screen bg-background fixed ">
  <div class="flex items-center pl-6 ">
    <img src={Logo} alt="Canela Logo" class="h-24 p-4" />
    <div class=" ">
      <p class="text-4xl font-bold italic font-serif text-blue">Canela</p>
      <p class="text-xl font-jetbrains-mono text-gray-800"><b>GIS - DATA - PROGRAMMING</b></p>
    </div>  
  </div>
