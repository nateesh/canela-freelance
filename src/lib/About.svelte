...
<div class="">
  ...
  <li>Enterprise GIS Training - ArcGIS Pro, Enterprise.</li>
  <li>Open-source GIS Training - QGIS.</li>
  <li>Custom Geo-spatial scripting (Python).</li>
  <li>Data processing, automation, Supervised machine-learning</li>
